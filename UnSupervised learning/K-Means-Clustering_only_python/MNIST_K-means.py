...
def display_digit(digit, labeled = True, title = ""):
    ...
    if title != "":
        plt.title("Inferred label: " + str(title),fontsize=30)
    plt.show()
...
"""
Show the results of 10 clusters
"""
k = 10
...
eights = []
nines = []
frequency0 = {x:0 for x in range(10)}
frequency1 = {x:0 for x in range(10)}
frequency2 = {x:0 for x in range(10)}
frequency3 = {x:0 for x in range(10)}
frequency4 = {x:0 for x in range(10)}
frequency5 = {x:0 for x in range(10)}
frequency6 = {x:0 for x in range(10)}
frequency7 = {x:0 for x in range(10)}
frequency8 = {x:0 for x in range(10)}
frequency9 = {x:0 for x in range(10)}
...
"""
To explore the relation between the nums of clusters and erreo rate
"""
# error_rates = {x:None for x in range(5,25)+[100]}
# print("first ok!")
# for k in range(2,12):
#     print(" %s clusters processing" %k)
#     trained_clusters, trained_centroids = cluster(training, k)
#     labelled_centroids = assign_labels_to_centroids(trained_clusters, trained_centroids)
